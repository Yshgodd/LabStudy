  ...
  return (
    <div className ='bg-black h-screen'>
      <div className = 'w-10/12 mx-auto items-center'>
        ...
        <div>
          <div className = 'form'>
            <div className = 'md:w-1/2 mx-auto mt-40 rounded bg-slate-800'>
              <form className='flex flex-col space-y-5 rounded p-10'>
                ...
                <button className= 'w-72 text-white text-center text-2xl rounded-md cursor-pointer hover:bg-white hover:text-black bg-black p-3 mx-auto'>Log In</button>
              </form>
            </div>
          </div>
        </div>
